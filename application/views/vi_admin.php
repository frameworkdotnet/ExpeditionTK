...
<html lang="en">
    <head>
        ...
        <title>Admin - TK Expedition</title>
                    ...
                    <div class="tk_fitur_wrapper">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                                <div class="cek_tarif_form">
                                    <div class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-3 control-label">Status Pengiriman</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <button type="button" name="tandai1" class="btn btn-info">Tandai Pengiriman</button>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="profile">
                                <div class="form-horizontal" role="form">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Online Shop</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="onlineshop" class="form-control" id="inputEmail3" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <button type="button" name="tandai2" class="btn btn-info">Tandai Pengiriman</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="alert alert-info cek_tarif_result"></div>
